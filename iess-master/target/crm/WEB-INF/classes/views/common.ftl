...
<link rel="stylesheet" href="${ctx}/css/note.css">
<link href="${ctx}/css/bootstrap/css/bootstrap.css" rel="stylesheet">
<link href="${ctx}/css/sweetalert/sweetalert2.min.css" rel="stylesheet">
<#--<link rel="stylesheet" href="${ctx}/plugin/layui/css/layui.css">-->
<script src="${ctx}/lib/layui-v2.5.5/layui.js" charset="utf-8"></script>
<script src="${ctx}/css/sweetalert/sweetalert2.min.js"></script>
<script src="${ctx}/lib/jquery-3.4.1/jquery-3.4.1.min.js"></script>
